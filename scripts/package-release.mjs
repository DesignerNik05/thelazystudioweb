...
console.log("       DELETE index.html, .htaccess and assets/ FIRST —");
console.log("       cPanel Extract skips files that already exist.");
console.log("    2. Leave rms/, thelazystudio.com/ and the two big zips alone");
